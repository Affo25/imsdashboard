...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Users', href: '/dashboard/users', icon: FiUsers, current: false, adminOnly: true },
    { name: 'Settings', href: '/dashboard/settings', icon: FiSettings, current: false },
  ];
    ...
    <div className="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white">
      ...
      <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
        <div className="flex items-center w-full">
          ...
          <button
            onClick={onLogout}
            className="ml-auto bg-white p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
            title="Logout"
          >
